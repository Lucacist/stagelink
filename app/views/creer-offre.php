    ...
    <form method="post" action="creer-offre.php">
        ...
        <div class="form-group">
            ...
            <select id="entreprise_id" name="entreprise_id" required>
                ...
                <option value="<?= $row['id'] ?>" <?= isset($_POST['entreprise_id']) && $_POST['entreprise_id'] == $row['id'] ? 'selected' : '' ?>>
            ...
            <div class="checkbox-grid">
                ...
                <div class="checkbox-item">
                    <input type="checkbox" 
                           ...
                           name="competences[]" 
                           value="<?= $row['id'] ?>"
                           <?= in_array($row['id'], $selected_competences) ? 'checked' : '' ?>>
                    <label for="comp_<?= $row['id'] ?>"><?= htmlspecialchars($row['nom']) ?></label>
                </div>
                <?php endwhile; ?>
            </div>
